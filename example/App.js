...
export default class App extends Component {
  ...
  enrolPhotoAndLaunchIProov = () => {
    this.apiClient.getToken("liveness", 'enrol', uuidv4()).then(data => { 
      console.log('Enrolling photo with token: ' + data.token);
      this.apiClient.enrolPhoto(data.token, testPhoto, 'oid').then(resp => {
        console.log('Launching iProov')
        IProov.launch('https://beta.rp.secure.iproov.me/api/v2/', resp.token, options, (e) => this.eventHandler(e));
      })
    })
  }
