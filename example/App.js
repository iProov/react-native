...
export default class App extends Component {
  ...
  launchIProov = async () => {
    ...
    IProov.launch(this.config.baseUrl, body.token, options, (e) =>
      this.eventHandler(e)
    )
  }

  enrolPhotoAndLaunchIProov = async () => {
    let response = await this.apiClient.enrolPhotoAndGetVerifyToken(
      uuidv4(),
      'liveness',
      testPhoto,
      'oid'
